...
public class FileUtil {
     ...
     */
    @SuppressWarnings("unchecked")
    public static String readStringFromSdcard(String folder, String fileName) {
//      BufferedInputStream objectInputStream = null;
      FileInputStream inputStream=null;
      try {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
          File fileDir = new File(Environment.getExternalStorageDirectory().getPath() + folder + fileName + ".txt");
          if (fileDir.exists()) {
     ...
     * @param object
     */
    public static boolean writeStringToSdcard(String folder, String fileName, Object object) {
//      ObjectOutputStream objectOutputStream = null;
      FileOutputStream fos=null;
      try {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
          File fileDir = new File(Environment.getExternalStorageDirectory().getPath() + folder);
          if (!fileDir.exists()) {
            fileDir.mkdirs();
          }
          File file = new File(fileDir.getPath() + "/" + fileName + ".txt");
          if (!file.exists()) {
            file.createNewFile();
          }
