...
public class JSONArrayHelper {
    ...
    public boolean isContainsObjectStr(Object object, List<Object> copyValues) {
        try {
            String idOnMore = ((JSONObject) object).optString(HttpConstants.Data.BaseMyFavoriteList.ID);
            for (Object obj : copyValues) {
                String idOnOld = ((JSONObject) obj).optString(HttpConstants.Data.BaseMyFavoriteList.ID);
