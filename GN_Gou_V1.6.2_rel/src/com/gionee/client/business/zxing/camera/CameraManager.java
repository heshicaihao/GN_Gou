...
package com.gionee.client.business.zxing.camera;
...
public final class CameraManager {
    ...
    private static int MAX_FRAME_WIDTH = 210;
    private static int MAX_FRAME_HEIGHT = 195;
    private static int CAMERA_PADDING = 40;
    private static int CAMERA_PADDING_TOP = 48;
    ...
    public static void init(Context context) {
        if (cameraManager == null) {
            ...
            MAX_FRAME_WIDTH = (int) (denisty * MAX_FRAME_WIDTH);
            MAX_FRAME_HEIGHT = (int) (denisty * MAX_FRAME_HEIGHT);
            CAMERA_PADDING = (int) (denisty * CAMERA_PADDING);
            CAMERA_PADDING_TOP = (int) denisty * CAMERA_PADDING_TOP;
        }
    }
        ...
        try {
            ...
            if (framingRect == null) {
                ...
                int topOffset = (screenResolution.y - height) / 2
                        - (int) context.getResources().getDisplayMetrics().density * 32;
...
//      rect.bottom = rect.bottom * cameraResolution.y / screenResolution.y;
            rect.left = (rect.left - CAMERA_PADDING) * cameraResolution.y / screenResolution.x;
            rect.right = (rect.right + CAMERA_PADDING) * cameraResolution.y / screenResolution.x;
//             rect.top = (rect.top - CAMERA_PADDING) * cameraResolution.x / screenResolution.y;
            rect.bottom = (rect.bottom + CAMERA_PADDING) * cameraResolution.x / screenResolution.y;
            rect.top = CAMERA_PADDING_TOP;
     ...
     * @return An array of Points scaled to the size of the framing rect and offset appropriately so they can
     *         be drawn in screen coordinates.
     */
    /*
