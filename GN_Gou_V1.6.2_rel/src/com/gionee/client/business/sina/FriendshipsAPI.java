...
public class FriendshipsAPI extends AbsOpenAPI {
     ...
     *            异步请求回调接口
     */
    public void friends(long uid, int count, int cursor, boolean trimStatus, RequestListener listener) {
        WeiboParameters params = buildFriendsParam(count, cursor, trimStatus);
        params.put("uid", uid);
     ...
     *            异步请求回调接口
     */
    public void friends(String screenName, int count, int cursor, boolean trimStatus, RequestListener listener) {
        WeiboParameters params = buildFriendsParam(count, cursor, trimStatus);
     ...
     *            异步请求回调接口
     */
    public void inCommon(long uid, long suid, int count, int page, boolean trimStatus,
            RequestListener listener) {
        WeiboParameters params = buildFriendIDParam(uid, count);
        params.put("suid", suid);
        params.put("page", page);
        params.put("trim_status", trimStatus ? 1 : 0);
     ...
     *            异步请求回调接口
     */
    public void friendsIds(String screenName, int count, int cursor, RequestListener listener) {
     ...
     *            异步请求回调接口
     */
    public void followers(long uid, int count, int cursor, boolean trimStatus, RequestListener listener) {
        WeiboParameters params = buildFriendIDParam(uid, count);
        params.put("cursor", cursor);
        params.put("trim_status", trimStatus ? 1 : 0);
     ...
     *            异步请求回调接口
     */
    public void followers(String screenName, int count, int cursor, boolean trimStatus,
            RequestListener listener) {
        WeiboParameters params = buildFriendsParam(count, cursor, trimStatus);
        params.put("screen_name", screenName);
        requestAsync(SERVER_URL_PRIX + "/followers.json", params, HTTPMETHOD_GET, listener);
     ...
     *            异步请求回调接口
     */
    public void followersIds(String screenName, int count, int cursor, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("screen_name", screenName);
        params.put("count", count);
        params.put("cursor", cursor);
     ...
     *            异步请求回调接口
     */
    public void show(long sourceId, long targetId, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
     ...
     *            异步请求回调接口
     */
    public void show(long sourceId, String targetScreenName, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("source_id", sourceId);
     ...
     *            异步请求回调接口
     */
    public void show(String sourceScreenName, long targetId, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
     ...
     *            异步请求回调接口
     */
    public void show(String sourceScreenName, String targetScreenName, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("target_screen_name", targetScreenName);
        params.put("source_screen_name", sourceScreenName);
        requestAsync(SERVER_URL_PRIX + "/show.json", params, HTTPMETHOD_GET, listener);
     ...
     *            异步请求回调接口
     */
    public void create(long uid, String screenName, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("uid", uid);
        params.put("screen_name", screenName);
     ...
     */
    @Deprecated
    public void create(String screenName, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("screen_name", screenName);
        requestAsync(SERVER_URL_PRIX + "/create.json", params, HTTPMETHOD_POST, listener);
    }
     ...
     *            异步请求回调接口
     */
    public void destroy(long uid, String screenName, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("uid", uid);
        params.put("screen_name", screenName);
     ...
     */
    @Deprecated
    public void destroy(String screenName, RequestListener listener) {
        WeiboParameters params = new WeiboParameters();
        params.put("screen_name", screenName);
        requestAsync(SERVER_URL_PRIX + "/destroy.json", params, HTTPMETHOD_POST, listener);
    }
    ...
    /** 组装FriendsParam的参数 */
    private WeiboParameters buildFriendsParam(int count, int cursor, boolean trimStatus) {
        WeiboParameters params = new WeiboParameters();
        params.put("count", count);
        params.put("cursor", cursor);
        params.put("trim_status", trimStatus ? 1 : 0);
