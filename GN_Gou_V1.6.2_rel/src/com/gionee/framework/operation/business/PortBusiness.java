...
//    }
    ...
    protected boolean checkNet(final FRequestEntity requestEntity, final Object session) throws Exception {
        ...
        if (!isNetworkAvailable) {
            requestEntity.mHandle.onErrorResult(requestEntity.mBusinessType, "", requestEntity.mHandle
                    .getSelfContext().getResources().getString(R.string.upgrade_error_network_exception),
                    session);
        }
