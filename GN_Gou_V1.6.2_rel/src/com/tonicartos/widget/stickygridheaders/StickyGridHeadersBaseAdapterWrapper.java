...
/**
 * Adapter wrapper to insert extra views and otherwise hack around GridView to add sections and headers.
 * 
 * @author Tonic Artos
 */
public class StickyGridHeadersBaseAdapterWrapper extends BaseAdapter {
     ...
     * <p>
     * Since this wrapper inserts fake entries to fill out items grouped by header and also spaces to insert
     * headers into some positions will return null.
     * </p>
     * 
     * @param position
    ...
    /**
     * Counts the number of items that would be need to fill out the last row in the group of items with the
     * given header.
     * 
     * @param header
    ...
    protected class HeaderFillerView extends FrameLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (v.getVisibility() != View.GONE) {
                int heightSpec = getChildMeasureSpec(MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
                        0, params.height);
