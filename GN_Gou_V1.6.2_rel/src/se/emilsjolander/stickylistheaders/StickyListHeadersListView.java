...
/**
 * Even though this is a FrameLayout subclass we still consider it a ListView. This is because of 2 reasons:
 * 1. It acts like as ListView. 2. It used to be a ListView subclass and refactoring the name would cause
...
public class StickyListHeadersListView extends FrameLayout {
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         *            The view parent
         * @param header
         *            The currently sticky header being offset. This header is not guaranteed to have it's
         *            measurements set. It is however guaranteed that this view has been measured, therefor
         *            you should user getMeasured* methods instead of get* methods for determining the view's
         *            size.
         * @param offset
    ...
    public interface OnStickyHeaderChangedListener {
         ...
         * @param itemPosition
         *            The position of the item within the adapter's data set of the item whose header is now
         *            sticky.
         * @param headerId
    ...
    public StickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            try {
                // -- View attributes --
                int padding = a.getDimensionPixelSize(R.styleable.StickyListHeadersListView_android_padding,
                        0);
                ...
                mAreHeadersSticky = a
                        .getBoolean(R.styleable.StickyListHeadersListView_hasStickyHeaders, true);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        try {
            mList.layout(0, 0, mList.getMeasuredWidth(), getMeasuredHeight());
            if (mHeader != null) {
                MarginLayoutParams lp = (MarginLayoutParams) mHeader.getLayoutParams();
                int headerTop = lp.topMargin + stickyHeaderTop();
                mHeader.layout(mPaddingLeft, headerTop, mHeader.getMeasuredWidth() + mPaddingLeft, headerTop
        ...
        if (mHeaderPosition == null || mHeaderPosition != headerPosition) {
            ...
            if (mHeaderId == null || mHeaderId != headerId) {
                ...
                if (mOnStickyHeaderChangedListener != null) {
                    mOnStickyHeaderChangedListener.onStickyHeaderChanged(this, mHeader, headerPosition,
                            mHeaderId);
                }
    ...
    private class AdapterWrapperHeaderClickHandler implements AdapterWrapper.OnHeaderClickListener {
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            mOnHeaderClickListener.onHeaderClick(StickyListHeadersListView.this, header, itemPosition,
                    headerId, false);
        }
    ...
    /**
     * Use the method with extreme caution!! Changing any values on the underlying ListView might break
     * everything.
     * 
